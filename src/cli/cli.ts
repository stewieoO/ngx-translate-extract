...
import { UIMessageParser } from '../parsers/uimessage.parser';
...
// Parsers
const parsers: ParserInterface[] = [new PipeParser(), new DirectiveParser(), new ServiceParser(), new MarkerParser(), new MetaParser(), new UIMessageParser()];
